...
const top50Rows = rows.slice(0, 50);
const ws = XLSX.utils.aoa_to_sheet([headers, ...top50Rows]);
ws['!cols'] = [
  { wch: 10 },
  { wch: 18 },
  { wch: 52 },
...
const outputPath = path.resolve(__dirname, '..', '..', 'Top_50_Merged_Best_Test_Cases_VMS_Detailed.xlsx');
